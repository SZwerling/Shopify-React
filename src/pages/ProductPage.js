...
const ProductPage = () => {
    ...
    const { fetchProductWithHandle, addItemToCheckout, product, fetchAllProducts, products } = useContext(ShopContext) 
...
<Button onClick={() => {addItemToCheckout(product.variants[0].id, 1)}}>buy</Button> */}